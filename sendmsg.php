...
$idPush = 'Ude928b040ac88f570c6b964ee22c6d99';

$httpClient = new \LINE\LINEBot\HTTPClient\CurlHTTPClient($access_token);
$bot = new \LINE\LINEBot($httpClient, ['channelSecret' => $channelSecret]);
$textMessageBuilder = new \LINE\LINEBot\MessageBuilder\TextMessageBuilder($_GET["message"]);
$response = $bot->pushMessage($_GET["lineid"], $textMessageBuilder);
